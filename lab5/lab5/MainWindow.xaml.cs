...
namespace lab5
{
    public partial class MainWindow : Window
    {
        ...
        private void LoadData()
        {
            ...
            {
                // UnitComboBox.SelectedIndex = 0; // Вибрати перший елемент
                // Або краще не вибирати нічого за замовчуванням
        ...
        // --- НОВИЙ ОБРОБНИК: Вкладка 5: Пошук товару за одиницею виміру ---
        private void SearchByUnitButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (UnitComboBox.SelectedValue != null)
            {
                ...
                // Припускаємо, що Код_одиниці_виміру - це int. Якщо інший тип, змініть (int)
                ...
                ProductsByUnitDataGrid.ItemsSource = db.Товари
                    ...
                    {
                        t.Артикул,
                        // Отримуємо назву одиниці (можна взяти з вибраного елемента ComboBox, але так надійніше)
                        Одиниця = t.Одиниці_виміру != null ? t.Одиниці_виміру.Одиниця_виміру : "(не вказано)",
                        t.Кількість,
                        t.Ціна
                    })
